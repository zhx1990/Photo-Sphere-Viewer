    ...
    <div id="form">
      <md-card v-show="!editMarkers">
          ...
          <md-tabs md-elevation="1" class="md-primary">
            <md-tab md-label="Panorama">
              <div class="md-layout md-gutter">
                <md-button class="md-dense md-raised" style="margin: 15px 0 0 20px; width: 150px"
            ...
            <md-tab md-label="Standard options">
              ...
              <div class="md-layout md-gutter">
                ...
                <div class="md-layout-item md-size-33">
                  <md-field>
                    <label>Autorotate zoom level</label>
                    <md-input type="number" min="0" max="100" v-model="options.autorotateZoomLvl" :disabled="!imageData"/>
                  </md-field>
                </div>
              </div>
              ...
              <div class="md-layout md-gutter">
                <div class="md-layout-item md-size-33 checkbox-field">
                  <md-checkbox class="md-primary" v-model="options.autorotateIdle" :disabled="!imageData">
                    Autorotate on idle
                  </md-checkbox>
                </div>
                <div class="md-layout-item md-size-33 checkbox-field">
        ...
        <md-card-actions md-alignment="space-between">
          <md-button class="md-accent" v-on:click="reset">
            Reset
          </md-button>
      ...
      <md-card v-show="editMarkers">
        ...
        <md-card-area>
          <md-card-content v-if="markerForm.type">
            ...
            <div class="md-layout md-gutter"
                 v-if="markerForm.type === 'image' || markerForm.type === 'imageLayer' || markerForm.type === 'html'">
...
<script>
  ...
  const DEFAULT_OPTIONS = omit(PhotoSphereViewer.DEFAULTS, ['panorama', 'panoData', 'sphereCorrection', 'container', 'plugins', 'navbar', 'loadingImg']);
  ...
  export default {
    ...
    methods: {
                ...
                .some(optName => {
                  if (!isEqual(this.options[optName], this.oldOptions[optName])) {
                    if (optName === 'autorotateIdle') {
                      this.viewer.setOption('autorotateDelay', this.options.autorotateIdle ? 2000 : null);
                    }
      ...
      applyNavbar() {
        this.viewer?.setOption('navbar', this.navbar.filter(i => i.enabled).map(i => i.code));
      },
