            ...
            <h2 v-bind:id="entry.id">
                ...
                <a v-bind:href="entry.url" class="release-link">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                        <path
                            fill="currentColor"
                            d="M50 19.2V4.8C50 2.1 47.9 0 45.2 0H30.8c-1.3 0-2.5.5-3.4 1.4l-26 26a4.6 4.6 0 0 0 0 6.6L16 48.7a4.6 4.6 0 0 0 6.5 0l26-26.1c1-.9 1.5-2 1.5-3.4zm-11.2-8a3.5 3.5 0 1 1 4.9-4.9 3.5 3.5 0 0 1-4.9 4.9z"
                        />
                    </svg>
                </a>
            </h2>
